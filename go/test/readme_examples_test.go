...
const testSeed = `map[string]any{"entity": map[string]any{"event": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "league": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "player": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "team": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
