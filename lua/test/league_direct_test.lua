...
describe("LeagueDirect", function()
  it("should direct-list-league", function()
    local setup = league_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-league", setup.live and "live" or "unit")
