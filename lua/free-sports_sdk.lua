...
local FreeSportsSDK = {}
FreeSportsSDK.__index = FreeSportsSDK
...
FreeSportsSDK._make_feature = _make_feature


function FreeSportsSDK.new(options)
  local self = setmetatable({}, FreeSportsSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function FreeSportsSDK:options_map()
...
function FreeSportsSDK:get_utility()
  return Utility.copy(self._utility)
end


function FreeSportsSDK:get_root_ctx()
  return self._rootctx
end


function FreeSportsSDK:prepare(fetchargs)
...
function FreeSportsSDK:direct(fetchargs)
  local utility = self._utility
...
function FreeSportsSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = FreeSportsSDK.new(sdkopts)
  sdk.mode = "test"
