# FreeSports SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FreeSportsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FreeSportsSDK(...) and FreeSportsSDK.test(...) become
#      FreeSportsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "freesports_sdk"
_SDK_CLASS = "FreeSportsSDK"
