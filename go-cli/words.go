...
func registerSDKWords(r *eng.Registry, client *sdk.FreeSportsSDK) {
...
func runOp(client *sdk.FreeSportsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
