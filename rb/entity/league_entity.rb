...
class LeagueEntity
  ...
  #
  # @param reqmatch [LeagueListMatch, Hash, nil] match filter (any subset of
  #   League fields); defaults to nil, treated as an empty match that lists all.
