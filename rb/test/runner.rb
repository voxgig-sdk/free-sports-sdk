...
module FreeSportsTestRunner
  ...
  def self.env_override(m)
    live = getenv("FREESPORTS_TEST_LIVE")
    override = getenv("FREESPORTS_TEST_OVERRIDE")
    ...
    explain = getenv("FREESPORTS_TEST_EXPLAIN")
    m["FREESPORTS_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = FreeSportsTestRunner
Helpers = FreeSportsHelpers
Vs = VoxgigStruct
