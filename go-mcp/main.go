// Command FreeSports-mcp is an MCP server exposing the FreeSports
// SDK as MCP tools.
//
// Two tools are registered:
//
//	FreeSports_list  — list records of an entity
//	FreeSports_load  — load a single record of an entity
//
