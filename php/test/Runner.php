...
class FreeSportsTestRunner
{
    ...
    {
        $live = self::getenv('FREESPORTS_TEST_LIVE');
        $override = self::getenv('FREESPORTS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('FREESPORTS_TEST_EXPLAIN');
...
class_alias('FreeSportsTestRunner', 'Runner');
class_alias('FreeSportsHelpers', 'Helpers');
