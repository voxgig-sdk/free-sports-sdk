...
// FreeSports SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FreeSportsSDK::test)
...
{
    private const SDK_CLASS = 'FreeSportsSDK';
    ...
    private const SDK_BASE = 'freesports_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../freesports_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
