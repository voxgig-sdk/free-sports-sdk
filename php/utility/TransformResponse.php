...
// FreeSports SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FreeSportsTransformResponse
{
    public static function call(FreeSportsContext $ctx): mixed
    {
        ...
        $transform = FreeSportsHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
