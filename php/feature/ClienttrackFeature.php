...
// FreeSports SDK clienttrack feature
...
class FreeSportsClienttrackFeature extends FreeSportsBaseFeature
{
    ...
    public function PostConstruct(FreeSportsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FreeSports-SDK';
