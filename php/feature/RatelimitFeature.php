...
// FreeSports SDK ratelimit feature
...
class FreeSportsRatelimitFeature extends FreeSportsBaseFeature
{
    ...
    private function _acquire(FreeSportsContext $ctx): void
    {
    ...
    private function _track(FreeSportsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
