...
// FreeSports SDK telemetry feature
...
class FreeSportsTelemetryFeature extends FreeSportsBaseFeature
{
    ...
    private function _close(FreeSportsContext $ctx, bool $ok): void
    {
