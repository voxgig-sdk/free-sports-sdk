...
class FreeSportsProxyFeature extends FreeSportsBaseFeature
{
    ...
    public function init(FreeSportsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FreeSportsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
