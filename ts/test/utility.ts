...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.FREESPORTS_TEST_LIVE ||
    'TRUE' === process.env.FREESPORTS_TEST_OVERRIDE
  ) {
  ...
  m.FREESPORTS_TEST_EXPLAIN = process.env.FREESPORTS_TEST_EXPLAIN || m.FREESPORTS_TEST_EXPLAIN
