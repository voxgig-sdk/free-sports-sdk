...
class FreeSportsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeSportsTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = FreeSportsTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = FreeSportsTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
