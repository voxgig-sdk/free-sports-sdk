...
from core.control import FreeSportsControl
...
class FreeSportsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, FreeSportsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FreeSportsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FreeSportsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FreeSportsError(code, msg, self)
