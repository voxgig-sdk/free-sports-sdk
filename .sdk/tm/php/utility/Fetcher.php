...
// FreeSports SDK utility: fetcher

class FreeSportsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FreeSportsSDK/1.0)';
    ...
    public static function call(FreeSportsContext $ctx, string $fullurl, array $fetchdef): array
    {
