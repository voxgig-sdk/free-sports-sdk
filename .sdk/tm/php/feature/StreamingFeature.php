...
// FreeSports SDK streaming feature
...
class FreeSportsStreamingFeature extends FreeSportsBaseFeature
{
    ...
    private function _iterate(FreeSportsResult $result): \Generator
    {
    ...
    private function _streamable(FreeSportsContext $ctx): bool
    {
