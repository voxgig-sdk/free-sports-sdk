...
class FreeSportsCacheFeature extends FreeSportsBaseFeature
{
    ...
    private function _through(FreeSportsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
