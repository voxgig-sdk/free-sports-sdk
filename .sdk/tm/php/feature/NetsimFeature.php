...
class FreeSportsNetsimFeature extends FreeSportsBaseFeature
{
    ...
    private function _simulate(FreeSportsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FreeSportsContext $ctx, array $applied): void
    {
        $client = $this->client;
