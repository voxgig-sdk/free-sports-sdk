...
// FreeSports SDK timeout feature
...
class FreeSportsTimeoutFeature extends FreeSportsBaseFeature
{
    ...
    private function _with_timeout(FreeSportsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FreeSportsContext $_ctx, float $ms): void
    {
        $client = $this->client;
