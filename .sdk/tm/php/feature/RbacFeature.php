...
class FreeSportsRbacFeature extends FreeSportsBaseFeature
{
    ...
    private function _required(FreeSportsContext $ctx): ?string
    {
    ...
    private function _reject(FreeSportsContext $ctx, string $required): void
    {
    ...
    private function _track(FreeSportsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
